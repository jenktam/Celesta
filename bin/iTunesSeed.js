...
program
  ...
  .description("Seeds the Celesta database with metadata from an XML iTunes library file. " +
               "By default, we'll import Celesta's music.xml and your iTunes library.")
